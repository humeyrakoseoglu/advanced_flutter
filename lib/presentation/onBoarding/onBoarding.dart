      ...
      child: Column(
        children: [
          ...
          child:TextButton(onPressed: () {}, child: Text(
              AppStrings.skip,
            style:Theme.of(context).textTheme.subtitle2,textAlign: TextAlign.end,
          ), ),),
...
//Bottom için ayrı bir widget oluşturalım
    ...
    child: Row(
      ...
      children: [
        ...
        child: GestureDetector(
          ...
          onTap: (){
            //go previous slide. Animates the controlled PageView from the current page to the given page.
        ...
        Row(
          children: [
            //indexe göre slide'ın olduğu circle'ı belirliyoruz
        ...
        Padding(padding: EdgeInsets.all(AppPadding.p14),
          child: GestureDetector(
            ...
            onTap: (){
              //go next slide. Animates the controlled PageView from the current page to the given page.
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        child: Text(
          _sliderObject.title,style: Theme.of(context).textTheme.headline1,textAlign: TextAlign.center
        ),),
        Padding(padding: const EdgeInsets.all(AppPadding.p8),
          child: Text(
              _sliderObject.subTitle,style: Theme.of(context).textTheme.subtitle1,textAlign: TextAlign.center
          ),),
        SizedBox(
          height: AppSize.s60,
        ),
